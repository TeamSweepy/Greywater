...
/**
 * TODO: Implement horizontal scrollbar Copyright Team Sweepy - Robin de Jong 2014 All use outside of the Greywater Project is not permitted
 * unless express permission is granted. Email TeamSweepy@gmail.com to discuss usage.
 */
...
public class ScrollBar {
	...
	public void draw(SpriteBatch batch) {
		if (visible) {
			...
			scrollerBackground.draw(batch, scroller.x - Camera.getDefault().xOffsetAggregate, y - (scroller.y - h + (scroller.height)) - Camera.getDefault().yOffsetAggregate,
